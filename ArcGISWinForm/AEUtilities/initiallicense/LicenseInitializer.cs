...
{
    /* 
  创建时间：2016/11/01 16:29  
  创建人：Shen
  用途：证书初始化类，内部类，只供AutoInitializer类使用
  备注：该类来源于AE的Sample代码
*/
    internal sealed class LicenseInitializer
    {
        //获取当前版本的runtimeinfo
        public ESRI.ArcGIS.RuntimeInfo GetCurrentRuntimeInfo()
        {
            RuntimeInfo runtimeInfo = RuntimeManager.ActiveRuntime;
            return runtimeInfo;
        }
